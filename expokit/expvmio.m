%  [w, err, hump,VM,bt,expH] = expvmio( t, A, v, tol, m )
...
%  To appear in ACM - Transactions On Mathematical Software (1998)

function [w, err, hump,VM,bt,expH,Tstep] = expv( t, A, v, tol, m )
